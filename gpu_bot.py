...
def send_email(title):
    ...
    server.login("spamingdump@gmail.com" , "s7qzYjBCFBG1")  
    server.sendmail("spamingdump@gmail.com" , "spamingdump@gmail.com" , title)
    server.close() 
...
def clickable(title, button):
    if button.is_enabled():
        ...
        print("Not clickable shoudl refresh now")
